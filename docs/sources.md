...
Three more GPL-3.0 repositories carry Froggo's work for 573. [ArunTS96/FroggoMorphePatches](https://github.com/ArunTS96/FroggoMorphePatches) adds suggested-post filtering and a Following-feed home, spread over several branches. [mben25/morphe-patches](https://github.com/mben25/morphe-patches) carries the clearest current copy of the 11 Facebook patches inside a bundle for many other apps, and a Material You resource map. [anemia004/xD-MorphePatches](https://github.com/anemia004/xD-MorphePatches) is archived with a reworked downloader. [nambara4-debug/Nambara-Facebook-Patches](https://github.com/nambara4-debug/Nambara-Facebook-Patches) holds two ZIP files of download variants and no licence, so it's behavior-only.
