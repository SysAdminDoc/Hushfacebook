...
.DESCRIPTION
    ...
    scripts/injected-mutation-contracts.txt: one feed guard, in addNewEdgeToCollection, and each
    story-flag stub calling GraphQLStory's accessor before it returns.
